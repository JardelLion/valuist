...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="dist/listaNegraNome.css">
        ...
        <div class="container-sm">
            ...
            <form action="#" method="post">
                ...
                <div class="col-sm">
                    ...
                    <div class="lista-negra__nome-div input-group-sm">
                        <!-- btn modal slide -->
                        <button type="button" class="lista-negra__nome-btn btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSlide">NOTAS</button>
                    </div>
                
                 
                
                    <div class="lista-negra__nome-div input-group-sm">
                    <button type="button" class="lista-negra__nome-btn btn btn-primary" id="openInputs">ALTERAR DADOS</button>
                    <button type="submit"  class="lista-negra__nome-btn btn-primary alterar" id="sendData" style="display:none;">ALTERAR</button>
                
                    </div>
                
                    <div class="lista-negra__nome-div input-group-sm">
                        <!--btn modal tirar da lista negra -->
                    <button type="button" class="lista-negra__nome-btn btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTirarDaListaNegra">TIRAR DA LISTA NEGRA</button>
                    </div>
                    ...
                    <textarea name="nota" id=""  rows="7" placeholder="Motivo..." required></textarea>
                </div>
                </div>
                <div class="row g-2">
                    <div class="col-sm">
               ...
               <?php include "Modal/modal_slide.php"?>
                ...
                <!-- Modal tirar da lista negra -->
                <?php include "Modal/modal_tirar_da_lista_negra.php"?>
