                        ...
                        <div class="modal-body" style="margin-bottom: 50px;">
                            ...
                            <div class="container-fluid">
                                <form action="#" method="post">
                                    ...
                                    <div class="input-group  input-group-sm mb-3">
                                        <select class="form-select" name="categoria" id="inputGroupSelect02" required>
                                    ...
                                    <div class="input-group  input-group-sm mb-3">
                                        <select class="form-select" name="natureza" id="inputGroupSelect02" required>
                                    ...
                                    <div class="input-group v input-group-sm mb-3">
                                        ...
                                        <select class="form-select" name="month" id="inputGroupSelect02" required>
                                        ...
                                        <select class="form-select" name="year" id="inputGroupSelect03" aria-label="Example select with button addon" required>
                                    ...
                                    <button type="button" class="descrisao-despesa__nome-btn btn-secondary" data-bs-dismiss="modal"> REJEITAR ALTERAÇÃO</button>
                                    <button type="submit" class="descrisao-despesa__nome-btn yellow-bg red-text">ACEITAR ALTERAÇÃO </button>
                                </form>
