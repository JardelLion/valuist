...
<head>
    ...
    <link rel="stylesheet" href="dist/clientes.css">
  ...
  <?php include "header.php"?>
    ...
    <main class="main container-sm">
        <div class="client-div">
            <button class="client-btn" id="ClientBtn">
                CADASTRAR CLIENTE
            </button>
        </div>

        <p class="total-client">8 CLIENTES</p>
        
        
        <button type="button" class=" container container-sm d-flex ">
            <p class="content-client">jardel</p>
            <p class="content-client">0302020200</p>
